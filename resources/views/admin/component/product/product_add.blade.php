        ...
        <div class="col-md-12 d-flex justify-content-center">
            <div class="card col-md-8 shadow-lg p-3 mb-5 bg-body rounded ">
                ...
                <div class="card-body card-block ">
                    <form action="{{route('page.create_product')}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row form-group col-md-6 ">
                                <div class="input-group mb-3 ">
                                    ...
                                    <input type="number" class="form-control" name="quantity"
                                        placeholder="Nhập số lượng..." value="{{old('quantity')}}" min="1">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row form-group col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Mô tả sản phẩm ở đây"
                                        id="textarea" name="long_description"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row form-group col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Điểm đặc biệt"
                                        id="textarea" name="highlight"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row form-group col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Thông số sản phẩm"
                                        id="textarea" name="product_specification"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-9">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        <img id="imagePreview" src="{{asset('storage/Images/default_2.jpg')}}"
